...
public class DatabaseConfig {  
    ...
    private void initializeAzureSQLDatabase() {  
        ...
        String createCustomersTable = "IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'customers' AND type = 'U') " +  
                "BEGIN " +  
        ...
        String createHearingsTable = "IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'hearings' AND type = 'U') " +  
                "BEGIN " +  
